"""
Set of global variables shared across agents.models.robomimic
"""
...
try:
    from agents.models.robomimic.macros_private import *
except ImportError:
    from agents.models.robomimic.utils.log_utils import log_warning
    import agents.models.robomimic
    # log_warning(
    #     "No private macro file found!"\
    #     "\nIt is recommended to use a private macro file"\
    #     "\nTo setup, run: python {}/scripts/setup_macros.py".format(agents.models.robomimic.__path__[0])
    # )
