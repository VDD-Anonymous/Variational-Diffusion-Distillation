...
class TransformerGMMPolicyFull(GaussianPolicyFull):
    """
    ...
    def forward(self, x: ch.Tensor, goals: ch.Tensor = None, train: bool = True):
        ...
        flat_chol = rearrange(flat_chol, 'b t (n d) -> b n t d', n=self.n_components)
...
if __name__ == "__main__":
    ...
    n_components = 6
    window_size = 5
    model = TransformerGMMPolicyFull(obs_dim=obs_dim, action_dim=action_dim, goal_dim=goal_dim, n_components=n_components,
