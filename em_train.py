...
from vi.algorithms.em import AmortizedExpectationMaximization
...
class EMExperiments(experiment.AbstractIterativeExperiment):
    ...
    def initialize(
        ...
        self.em_agent = AmortizedExpectationMaximization.create_em_agent(policy_params=algo_config['policy_params'],
    ...
    def iterate(self, cw_config: dict, rep: int, n: int) -> dict:
        ...
        if n % self.env_rollout_interval == 0 and n > 0:
            rollout_dict = self.experiment_manager.env_rollout(self.em_agent.agent, self.num_env_rollouts)
